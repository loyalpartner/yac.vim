...
let s:default_groups = {
  ...
  \ 'YacTsMarkupHeading':        {'link': 'Title'},
  \ 'YacTsMarkupHeadingMarker':  {'link': 'Delimiter'},
  \ 'YacTsMarkupRawBlock':       {'link': 'String'},
  \ 'YacTsMarkupRawInline':      {'link': 'String'},
  \ 'YacTsMarkupLink':           {'link': 'Underlined'},
  \ 'YacTsMarkupLinkUrl':        {'link': 'Underlined'},
  \ 'YacTsMarkupLinkLabel':      {'link': 'Label'},
  \ 'YacTsMarkupListMarker':     {'link': 'Delimiter'},
  \ 'YacTsMarkupListChecked':    {'link': 'DiagnosticOk'},
  \ 'YacTsMarkupListUnchecked':  {'link': 'Comment'},
  \ 'YacTsMarkupQuote':          {'link': 'Comment'},
  \ 'YacTsMarkupItalic':         {'gui': 'italic', 'cterm': 'italic'},
  \ 'YacTsMarkupBold':           {'gui': 'bold', 'cterm': 'bold'},
  \ 'YacTsMarkupStrikethrough':  {'link': 'Comment'},
