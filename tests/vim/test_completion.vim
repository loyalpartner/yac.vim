...
" ============================================================================
" Test 1: Static method completion (User::)
" ============================================================================
call yac_test#log('INFO', 'Test 1: Static method completion on User::')
...
if !empty(popups)
  call yac_test#log('INFO', 'Static method completion popup appeared')
...
" ============================================================================
" Test 2: Import completion (use std::collections::Hash)
" ============================================================================
