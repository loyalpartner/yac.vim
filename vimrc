...
" 调试信息
function! YacStatus()
  echo "yac command: " . string(g:yac_command)
  echo "yac binary exists: " . (executable('./target/release/lsp-bridge') ? 'YES' : 'NO')
endfunction

command! YacStatus call YacStatus()
