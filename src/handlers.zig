...
pub const handlers = [_]Handler{
    ...
    .{ .name = "type_hierarchy", .handleFn = lsp_requests.handleTypeHierarchy },
    .{ .name = "formatting", .handleFn = lsp_requests.handleFormatting },
    .{ .name = "range_formatting", .handleFn = lsp_requests.handleRangeFormatting },
    .{ .name = "signature_help", .handleFn = lsp_requests.handleSignatureHelp },
