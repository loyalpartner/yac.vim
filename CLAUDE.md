...
```vim
let g:yac_command = ['./target/release/lsp-bridge']
let g:yac_auto_start = 1
```

### Auto-Completion Settings
```vim
let g:yac_auto_complete = 1          " Enable auto-completion (default: 1)
let g:yac_auto_complete_delay = 200  " Delay in milliseconds (default: 200)
let g:yac_auto_complete_min_chars = 1 " Minimum characters to trigger (default: 1)
```
